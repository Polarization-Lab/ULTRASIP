...
%% Starting settings: 
%wheel2 = load('cyclic_mrybm_35-75_c68_n256.csv');
wheel2 = abs(hsv(256)-1);
%wheel2(129:256,:) = flip(wheel2(1:128,:),1);
for i = 1:128
wheel2(i,:) = (wheel2((2*i),:));
end
wheel2(129:256,:) = (wheel2(1:128,:));
%wheel2(128:192,:) = (wheel2(1+64:129,:));
%wheel2(128:192,:) = (wheel2(129:,:));
currentAx = gca; 
cm = wheel2; 
...
% Plot a ring: 
[xc1,yc1] = pol2cart(linspace(0,2*pi,360),innerRadius); 
[xc2,yc2] = pol2cart(linspace(0,2*pi,360),outerRadius); 
...
if usedegrees
   ...
   text(xt(4),yt(4),'270\circ','horiz','center','vert','bottom'); 
else
   text(xt(1),yt(1),'-\pi','horiz','right','vert','middle'); 
