...
"""
@user: C.M.DeLeon
This script is to control the ULTRASIP FLIR DoFP Camer
from FLIR Spinnaker SDK Examples

NOTE: Must download SDK specific to python version 
from: https://www.flir.com/support-center/iis/machine-vision/downloads/spinnaker-sdk-download/?pn=Spinnaker+SDK&vn=Spinnaker_SDK
Latest is python 3.10 so make sure spyder is running Python 3.10
"""
